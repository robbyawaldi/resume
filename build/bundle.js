    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 1, 1, 9);
    			attr_dev(span0, "class", "font-semibold text-lg text-blue-400");
    			add_location(span0, file, 5, 9, 171);
    			attr_dev(h10, "class", "text-3xl font-thin md:text-left text-center leading-3");
    			add_location(h10, file, 4, 2, 94);
    			attr_dev(span1, "class", "block mt-3 font-semibold text-lg");
    			add_location(span1, file, 8, 3, 251);
    			add_location(p0, file, 7, 2, 243);
    			attr_dev(div0, "class", "content1");
    			add_location(div0, file, 3, 1, 68);
    			attr_dev(h11, "class", "font-semibold text-lg");
    			add_location(h11, file, 18, 2, 594);
    			add_location(h2, file, 22, 5, 715);
    			add_location(p1, file, 23, 5, 755);
    			add_location(li, file, 21, 4, 704);
    			attr_dev(ul, "class", "ml-3");
    			add_location(ul, file, 20, 3, 681);
    			attr_dev(div1, "class", "border-l-2 ml-2");
    			add_location(div1, file, 19, 2, 647);
    			attr_dev(div2, "class", "content2");
    			add_location(div2, file, 17, 1, 568);
    			attr_dev(h12, "class", "font-semibold text-lg");
    			add_location(h12, file, 35, 2, 1038);
    			add_location(p2, file, 36, 2, 1090);
    			attr_dev(div3, "class", "content3");
    			add_location(div3, file, 34, 1, 1012);
    			attr_dev(h13, "class", "font-semibold text-lg");
    			add_location(h13, file, 42, 2, 1212);
    			attr_dev(span2, "class", "chip");
    			add_location(span2, file, 44, 3, 1311);
    			attr_dev(span3, "class", "chip");
    			add_location(span3, file, 45, 3, 1352);
    			attr_dev(span4, "class", "chip");
    			add_location(span4, file, 46, 3, 1389);
    			attr_dev(span5, "class", "chip");
    			add_location(span5, file, 47, 3, 1423);
    			attr_dev(span6, "class", "chip");
    			add_location(span6, file, 48, 3, 1457);
    			attr_dev(span7, "class", "chip");
    			add_location(span7, file, 49, 3, 1492);
    			attr_dev(span8, "class", "chip");
    			add_location(span8, file, 50, 3, 1529);
    			attr_dev(span9, "class", "chip");
    			add_location(span9, file, 51, 3, 1565);
    			attr_dev(span10, "class", "chip");
    			add_location(span10, file, 52, 3, 1606);
    			attr_dev(span11, "class", "chip");
    			add_location(span11, file, 53, 3, 1642);
    			attr_dev(span12, "class", "chip");
    			add_location(span12, file, 54, 3, 1679);
    			attr_dev(span13, "class", "chip");
    			add_location(span13, file, 55, 3, 1717);
    			attr_dev(span14, "class", "chip");
    			add_location(span14, file, 56, 3, 1754);
    			attr_dev(span15, "class", "chip");
    			add_location(span15, file, 57, 3, 1792);
    			attr_dev(span16, "class", "chip");
    			add_location(span16, file, 58, 3, 1831);
    			attr_dev(span17, "class", "chip");
    			add_location(span17, file, 59, 3, 1871);
    			attr_dev(div4, "class", "flex gap-2 flex-wrap");
    			add_location(div4, file, 43, 2, 1272);
    			attr_dev(div5, "class", "content4");
    			add_location(div5, file, 41, 1, 1186);
